<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-xl text-gray-900 leading-tight">Edit Service</h2>
                <p class="text-xs text-gray-400 mt-0.5">{{ $service->name }}</p>
            </div>
        </div>
    </x-slot>
                            ...
                            <div class="px-7 pb-7 pt-1 grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" rows="3"
                                        ...
                                        placeholder="Write a short description customers will see when booking…">{{ old('description', $service->description) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="options_label" value="{{ old('options_label', $service->options_label) }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="options" value="{{ old('options', is_array($service->options) ? implode(', ', $service->options) : '') }}"
                        ...
                        <div class="accordion-body">
                            <div class="px-7 pb-7 pt-1 grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    @php $selSchedule = old('schedule_id', $service->schedule_id ?? ''); @endphp
                                    <div class="svc-select">
                                        ...
                                        <div class="svc-select-panel">
                                            <div class="svc-select-opt {{ $selSchedule === '' || $selSchedule === null ? 'selected' : '' }}" data-value="">— No schedule —</div>
                                ...
                                <div>
                                    ...
                                    @php $selInc = old('time_increment', $service->time_increment ?? 30); @endphp
                                    <div class="svc-select">
                                        <button type="button" class="svc-select-trigger">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="advance_booking_days"
                                            value="{{ old('advance_booking_days', $service->advance_booking_days ?? 60) }}" min="1"
                                            class="field-input pl-icon pr-14" placeholder="60">
                                        <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                            <span class="text-xs text-gray-400 font-medium">days</span>
                                        </div>
                                    </div>
                                    <p class="text-[11px] text-gray-400 mt-1.5">How far ahead customers can book</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="min_notice_hours"
                                            value="{{ old('min_notice_hours', $service->min_notice_hours ?? 4) }}" min="0"
                                            class="field-input pl-icon pr-14" placeholder="4">
                                        <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                            <span class="text-xs text-gray-400 font-medium">hrs</span>
                                        </div>
                                    </div>
                                    <p class="text-[11px] text-gray-400 mt-1.5">Minimum notice before a booking</p>
                                </div>
                            ...
                            <div class="px-7 pb-7 pt-1 space-y-5">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        @php $selBefore = old('buffer_before_minutes', $service->buffer_before_minutes ?? 0); @endphp
                                        <div class="svc-select">
                                            <button type="button" class="svc-select-trigger">
                                    ...
                                    <div>
                                        ...
                                        @php $selAfter = old('buffer_after_minutes', $service->buffer_after_minutes ?? 0); @endphp
                                        <div class="svc-select">
                                            <button type="button" class="svc-select-trigger">
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                                        ...
                                        <div class="w-full sm:w-36">
                                            <input type="number" name="max_bookings_per_day"
                                                value="{{ old('max_bookings_per_day', $service->max_bookings_per_day) }}" min="1"
                            ...
                            <div class="px-7 pb-7 pt-1 space-y-3">
                                ...
                                <div class="flex items-center justify-between p-5 rounded-2xl bg-gradient-to-r from-gray-50 to-white border border-gray-100">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                                        <input type="checkbox" name="collect_phone" value="1" {{ old('collect_phone', $service->collect_phone) ? 'checked' : '' }} class="sr-only peer">
                                        <div class="w-12 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-orange-400 rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:shadow after:transition-all peer-checked:bg-orange-500"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-5 rounded-2xl bg-gradient-to-r from-gray-50 to-white border border-gray-100">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                                        <input type="checkbox" name="collect_vehicle_reg" value="1" {{ old('collect_vehicle_reg', $service->collect_vehicle_reg) ? 'checked' : '' }} class="sr-only peer">
                                        <div class="w-12 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-orange-400 rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:shadow after:transition-all peer-checked:bg-orange-500"></div>
                                    </label>
                                </div>
                    ...
                    <div class="accordion-card bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="accordion-body">
                            <div class="px-7 pb-7 pt-1">
                                ...
                                @else
                                    @php $assignedIds = old('user_ids', $service->staff->pluck('id')->toArray()); @endphp
                                ...
                                <div class="flex items-center justify-between p-5 rounded-2xl bg-gradient-to-r from-gray-50 to-white border border-gray-100">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer shrink-0 ml-4">
                                        <input type="checkbox" name="send_confirmation_email" value="1"
                                            {{ old('send_confirmation_email', $service->send_confirmation_email) ? 'checked' : '' }}
                                            class="sr-only peer">
                                        <div class="w-12 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-orange-400 rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:shadow after:transition-all peer-checked:bg-orange-500"></div>
                                    </label>
                                </div>
