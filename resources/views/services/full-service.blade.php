    ...
    <div class="max-w-[1440px] mx-auto p-0 lg:p-6 w-full">
        ...
        <section class="relative w-full h-[80vh] lg:h-[100vh] overflow-hidden lg:rounded-2xl hero-image-clip">
            ...
            <div class="absolute inset-0 z-0 bg-black">
                <img src="{{ asset('images/e1fb2bc84fe01e7d1b967e474c3adf19a7403436.webp') }}" alt="Car maintenance and repairs"
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Check for
                                            leaks, unusual noises, or wear</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Test the
                                            lights, horn, and dashboard warning systems</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Inspect
                                            exhaust system for leaks or damage</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                ...
                <div class="flex flex-col group mt-8 lg:mt-0">
                    ...
                    <div class="entrance-anim entrance-hidden relative z-0 w-full transition-all duration-500 ease-out">
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Reduced fuel
                                efficiency</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Strange noises or
                                vibrations</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Warning lights on
                                the dashboard</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Brakes or steering
                                feel unusual</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">It’s been more than
                                12 months since your last service</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group pt-16">
                    ...
                    <div
                        ...
                        <h3
                            ...
                            Choose your service type (Standard or Full Service Plus)
                        </h3>
                    </div>
                </div>
                            ...
                            <div x-data="{ active: 1 }" class="space-y-0 border-t border-black/10 z-10 relative">
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 1 ? null : 1)"
                                        ...
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">How long does a full
                                            service take?</span>
                                    ...
                                    <div x-show="active === 1" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Typically 2–4 hours depending on the vehicle and service level.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 2 ? null : 2)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Do I need a full
                                            service if my car is running fine?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                    ...
                                    <div x-show="active === 2" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Yes. Full servicing prevents minor issues from escalating and ensures safety,
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 3 ? null : 3)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Does a full service
                                            include MOT?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                            <div class="absolute inset-0 rounded-md transition-all duration-300"
                                                style="clip-path: polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px);"
                                    ...
                                    <div x-show="active === 3" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            A full service is separate from an MOT, but it prepares your vehicle and
                                            identifies issues that could affect your MOT result.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="border-b border-black/10 py-6">
                                    ...
                                    <div x-show="active === 4" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Yes, all servicing work comes with a warranty for peace of mind.
                                        </p>
                                    </div>
                                </div>
                            </div>
