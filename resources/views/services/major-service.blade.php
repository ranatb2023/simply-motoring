...
@section('meta_title', 'Major Car Service in Doncaster | Simply Motoring')
    ...
    <div class="max-w-[1440px] mx-auto p-0 lg:p-6 w-full">
        ...
        <section class="relative w-full h-[80vh] lg:h-[100vh] overflow-hidden lg:rounded-2xl hero-image-clip">
            ...
            <div class="absolute inset-0 z-0 bg-black">
                <img src="{{ asset('images/ee44888feef80f8f5c5e1df0d3096610f4969c68.webp') }}" alt="Professional MOT inspection"
            ...
            <div class="relative z-10 w-full h-full flex flex-col justify-between py-10 lg:py-24 px-6 lg:px-20">
                ...
                <div class="mt-20 lg:mt-10 max-w-5xl">
                    ...
                    <p class="text-white text-2xl lg:text-[36px] font-medium font-geist tracking-tight lg:mt-4">
                        Thorough maintenance for complete vehicle care
                    </p>
                </div>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Examine belts,
                                            hoses, and engine components for wear or leaks</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Check pads,
                                            discs, and brake fluid condition</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Test lights,
                                            indicators, dashboard warning systems, horn, and battery</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Check
                                            electronic safety systems where applicable</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Examine
                                            exhaust, underbody, and fuel lines</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Road test to
                                            confirm overall vehicle performance</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Inspect
                                            calipers, brake lines, suspension arms, and shock absorbers</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Test braking
                                            performance and ride quality</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary rounded-xl p-8 w-full h-full flex flex-col border border-white/50">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Inspect tyre
                                            condition, tread depth, and pressures</span>
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="flex items-center justify-center shrink-0 mt-1">
                                            <i class="fa-light fa-tire text-2xl text-white"></i>
                                        </div>
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Check wheel
                                    ...
                                    <li class="flex items-start gap-4">
                                        ...
                                        <span class="text-lg lg:text-xl font-medium leading-tight text-white">Examine
                                            suspension components for wear or damage</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="flex flex-col group mt-8 lg:mt-0">
                    ...
                    <div class="entrance-anim entrance-hidden relative z-0 w-full transition-all duration-500 ease-out">
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Engine or transmission
                                issues</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Reduced braking or
                                steering performance</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Warning lights on the
                                dashboard</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">Unusual noises,
                                vibrations, or handling problems</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-xl lg:text-2xl font-semibold font-geist leading-tight">General wear due to
                                high mileage or age</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-[1440px] mx-auto px-6 relative">
                ...
                <div class="relative group pt-16">
                    ...
                    <div
                        ...
                        <h3
                            ...
                            Select your service type (Standard or Major Service Plus)
                        </h3>
                    </div>
                </div>
            ...
            <div class="flex justify-center">
                <a href="#book"
                    ...
                    <span class="relative z-10">Book Your Major Service Today</span>
                </a>
            </div>
                            ...
                            <div x-data="{ active: 1 }" class="space-y-0 border-t border-black/10 z-10 relative">
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 1 ? null : 1)"
                                        ...
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">What makes a major
                                            service different from a full service?</span>
                                    ...
                                    <div x-show="active === 1" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            A major service is more extensive, covering all vehicle systems, components, and
                                            safety checks, while a full service focuses on standard maintenance with key
                                            inspections.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 2 ? null : 2)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">How often should a
                                            major service be performed?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                    ...
                                    <div x-show="active === 2" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Typically, once a year or according to your manufacturer’s schedule, especially
                                            for vehicles with higher mileage.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 3 ? null : 3)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Can a major service
                                    ...
                                    <div x-show="active === 3" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Yes. By inspecting and maintaining every system, potential issues are caught
                                            early, preventing expensive breakdowns.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 4 ? null : 4)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Does a major service
                                            include fluid replacements?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                            <div class="absolute inset-0 rounded-md transition-all duration-300"
                                                style="clip-path: polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px);"
                                    ...
                                    <div x-show="active === 4" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Yes. All essential fluids are checked, topped up, or replaced as needed,
                                            including engine oil, brake fluid, and coolant.
                                        </p>
                                    </div>
                                </div>
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 5 ? null : 5)"
                                        class="w-full flex justify-between items-center text-left group">
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Is a major service
                                            suitable for high-mileage or older cars?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                            <div class="absolute inset-0 rounded-md transition-all duration-300"
                                                style="clip-path: polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px);"
                                    ...
                                    <div x-show="active === 5" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Absolutely. Major servicing ensures older or high-mileage vehicles stay safe,
                                            efficient, and reliable on the road.
                                        </p>
                                    </div>
                                </div>
                                <div class="border-b border-black/10 py-6">
                                    <button @click="active = (active === 6 ? null : 6)"
                                        ...
                                        <span class="text-xl lg:text-2xl font-medium text-black pr-8">Do you offer a
                                            warranty on parts and labour?</span>
                                        <div class="relative w-10 h-10 flex-shrink-0">
                                            <div class="absolute inset-0 rounded-md transition-all duration-300"
                                                style="clip-path: polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px);"
                                    ...
                                    <div x-show="active === 6" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            Yes. All major servicing work comes with a warranty for peace of mind.
                                        </p>
                                    </div>
                                </div>
                            </div>
