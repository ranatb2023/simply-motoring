...
@section('meta_title', 'Interim Car Service in Doncaster | Simply Motoring')
...
@section('content')
    ...
    <div class="max-w-[1440px] mx-auto p-0 lg:p-6 w-full">
        ...
        <section class="relative w-full h-[80vh] lg:h-[100vh] overflow-hidden lg:rounded-2xl hero-image-clip">
            ...
            <div class="absolute inset-0 z-0 bg-black">
                <img src="{{ asset('images/a8a27d00025e9690cd36a942843d05fd3b25f24a.webp') }}" alt="Car inspection workshop"
        ...
        <div class="max-w-[1440px] mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row gap-8 lg:items-center mb-12">
                <h2
                    ...
                    SIGNS YOU NEED AN Interim Service
                </h2>
    ...
    <section class="bg-white py-10 lg:py-20 w-full">
        <div class="max-w-[1440px] mx-auto px-6 relative">
            ...
            <!-- Steps Grid -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 lg:mb-16 mb-8">
