<x-guest-layout>
    <div class="mb-6 text-center lg:text-left">
        ...
        <p class="text-sm text-gray-500 mt-2">Let's get you started. Create your account by entering your details below.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="mb-4">
            <x-input-label for="name" :value="__('Name')" class="mb-1 block font-medium text-gray-700" />
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-gray-400" fill="none" class="w-6 h-6" stroke="currentColor"
                        viewBox="0 0 24 24">
        ...
        <div class="mt-4 text-center text-sm text-gray-600">
            Already have an account? <a href="{{ route('login') }}"
                class="text-primary hover:underline font-medium">Login</a>
        </div>
    </form>
</x-guest-layout>