...
<head>
    ...
    <style>
        ...
        .header { background: #ef4444; padding: 28px 40px; }
        ...
        .card-title { font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: #ef4444; margin-bottom: 14px; }
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="intro">A booking has been deleted from the admin dashboard. The customer has been notified.</p>
        ...
        <div class="footer">
            Booking ID #{{ $booking->id }} was deleted &nbsp;·&nbsp; Simply Motoring Admin
        </div>
    </div>
</body>
</html>