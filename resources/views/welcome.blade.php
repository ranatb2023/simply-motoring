...
@section('content')
        ...
        <div
            ...
            <div class="w-full lg:w-[50%] flex flex-col lg:justify-between py-10 lg:py-16 relative z-10 shrink-0 gap-10">
                ...
                <div class="hidden lg:flex flex-col gap-8">
                    ...
                    <div>
                        <a href="#book"
                            class="inline-flex items-center justify-center bg-black text-white text-xl font-bold uppercase tracking-widest px-24 py-5 hover:bg-primary hover:-translate-y-2 hover:translate-x-2 hover:shadow-2xl transition-all duration-300 shadow-lg group relative hero-btn-clip rounded-md">
                            BOOK Here
                        </a>
                    </div>
                </div>
    ...
    <!-- MOT Testing Section -->
    <section class="bg-white py-10 lg:py-20 relative z-10 border-b border-gray-100">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-10 flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
            ...
            <!-- Right Content Side -->
            <div class="w-full lg:w-1/2 flex flex-col items-start gap-8 lg:gap-10">
                <div class="flex flex-col gap-6">
                    <h2
                        class="font-geist font-semibold text-[48px] lg:text-[72px] leading-[0.85] tracking-tighter uppercase text-black">
                        MOT Testing <br><span class="text-primary">Made Simple</span>
                    </h2>
                    <p class="text-black/80 text-lg lg:text-xl font-medium leading-relaxed max-w-xl">
                        At Simply Motoring, we combine thorough MOT inspections with honest advice and transparent pricing
                        so you always know exactly where you stand.
                    </p>
                </div>

                <ul class="flex flex-col gap-4 lg:gap-5 w-full">
                    @php
                        $motFeatures = [
                            'DVSA-approved inspections',
                            'Brakes, tyres and safety system checks',
                    ...
                    @foreach ($motFeatures as $feature)
                        <li class="flex items-start gap-4">
                            <div class="mt-1 w-6 h-6 rounded-full bg-green-500/10 flex items-center justify-center shrink-0">
                                <i class="fa-solid fa-check text-green-500 text-[14px]"></i>
                            </div>
                            <span class="text-gray-800 text-[16px] lg:text-[18px] font-medium">{{ $feature }}</span>
                        </li>
                    @endforeach
                </ul>
                ...
                <div
                    ...
                    <div class="bg-white p-8 lg:p-10 flex flex-col justify-between flex-1 gap-10">
                        <ul class="flex flex-col gap-4">
                            ...
                            <li class="flex items-start gap-3">
                                <i class="fa-solid fa-check text-green-500 mt-1 text-sm"></i>
                                <span class="text-gray-700 text-[15px]">Manufacturer-specific checks meets minimum
                                    requirements for safety & efficiency</span>
                            </li>
                        </ul>
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between h-auto lg:h-[80%] gap-6 lg:gap-10">
                        <h2
                            ...
                            More Than Just MOT and Servicing
                        </h2>
                        ...
                        x-data="{ 
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        services: [
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            { 
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                desc: 'Squeaky brakes? Spongy pedal? Clutch slipping? Don\'t leave it. Faulty brakes and clutches are serious safety issues. Bring your car in for a free brake assessment.', 
                                                                                                                                                                                                                                                                                                cta: 'View All Services' 
                                                                                                                                                                                                                                                                                            },
                                                                                                                                                                                                                                                                                            //{ 
                                                                                                                                                                                                                                                                                                //id: 3, 
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            { 
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                desc: 'Dashboard warning light on? Our diagnostic tools reveal fault codes and can give a clear picture of your car’s health. ', 
                                                                                                                                                                                                                                                                                                cta: 'View All Services ' 
                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                        ]
                                                                                                                                                                                                                                                                                    }"
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="flex flex-col opacity-0 transition-opacity duration-500 delay-100"
                                            ...
                                            <a href="{{ route('service') }}"
                                                class="text-center w-full bg-primary hover:bg-[#ff5500] text-white font-bold py-4 px-6 uppercase tracking-wide transition-all shadow-lg text-sm"
                                                x-text="service.cta">
                                            </a>
                                        </div>
                                    </div>
            ...
            <div x-data="{
                ...
                <div class="bg-[#1A103C] rounded-[24px] p-6 lg:p-10 min-h-[200px] lg:min-h-[300px] flex flex-col justify-between group hover:bg-[#241654] transition-all duration-700 ease-out relative overflow-hidden"
                    ...
                    <p class="text-white/70 text-lg leading-[1.26] mt-auto z-10 relative lg:max-w-[90%] max-w-[100%]">
                        Choose your service from our website and book online or give us a call.
                    </p>
                </div>
    ...
    <section
        ...
        <div class="w-full">
            ...
            <div
                ...
                <!-- Content Container -->
                <div class="relative z-20 w-full max-w-[1440px] mx-auto h-full flex items-center justify-center lg:p-10">

                    <!-- Glass Content Card -->
                    <div
                        class="bg-white/10 backdrop-blur-sm lg:backdrop-blur-xl p-6 lg:p-10 lg:rounded-[20px] w-full lg:w-[90%] mx-auto relative">
                        ...
                        <style>
                            ...
                            .custom-scrollbar:hover::-webkit-scrollbar-thumb {
                                background-color: rgba(251, 82, 0, 0.5);
                            }
                        ...
                        <div
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-12">
                                <span
                                    class="bg-primary text-white px-5 py-2 rounded-full font-geist font-medium text-[16px] sm:text-[20px] leading-[1.26] tracking-[-0.06em] uppercase [leading-trim:CAP_HEIGHT] inline-block w-fit">
                                    Driven By Great Reviews
                                </span>

                                <!-- Navigation -->
                                <div class="flex lg:gap-10 gap-6 items-center justify-end">
                                    <button @click="prev()"
                            ...
                            <!-- Carousel Container -->
                            <div class="relative overflow-hidden cursor-grab active:cursor-grabbing" @mousedown="startDrag"
                                @touchstart.passive="startDrag" @mousemove="onDrag" @touchmove.passive="onDrag"
                                @mouseup="endDrag" @touchend="endDrag" @mouseenter="paused = true"
                                @mouseleave="paused = false">

                                <div class="flex transition-transform duration-500 ease-out"
                                    :class="transitioning ? '' : 'duration-0'"
                                    :style="`transform: translateX(calc(-${activeReview * (100 / (isMobile ? 1 : 3))}% + ${currentX}px))`">

                                    <template x-for="(review, index) in reviews" :key="index">
                                        <div :class="isMobile ? 'w-full' : 'w-1/3'" class="flex-shrink-0 px-4">
                                            <div
                                                class="bg-white/5 backdrop-blur-md p-6 rounded-[12px] h-full flex flex-col justify-between border border-white/10 group hover:bg-white/10 transition-all duration-300">
                                                <div>
                                                    <div class="flex gap-1 text-[#FB5200] mb-6">
                                                        <template x-for="i in 5">
                                                            <i class="fa-solid fa-star text-xs"></i>
                                                        </template>
                                                    </div>
                                                    <i
                                                        class="fa-solid fa-quote-left text-white/20 text-[48px] mb-6 block leading-none transition-transform duration-500"></i>

                                                    <div
                                                        class="relative h-[180px] lg:h-[200px] overflow-y-auto custom-scrollbar scroll-smooth pr-4">
                                                        <p class="font-geist font-medium text-[16px] lg:text-[20px] leading-[1.3] tracking-[-0.04em] text-white/90 cursor-default"
                                                            x-text="review.quote">
                                                        </p>
                                                    </div>
                                                </div>

                                                <div class="flex items-center gap-5 mt-8 pt-8 border-t border-white/10">
                                                    <div
                                                        class="w-14 h-14 relative rounded-full overflow-hidden border-2 border-primary/30">
                                                        <img :src="review.image" alt="Reviewer"
                                                            class="w-full h-full object-cover">
                                                    </div>
                                                    <div class="flex flex-col">
                                                        <h4 class="font-geist font-bold text-lg text-white"
                                                            x-text="review.name"></h4>
                                                        <span class="text-white/40 text-sm font-medium"
                                                            x-text="review.location"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            <h2
                                ...
                                What Our Customers<br>Usually Ask
                            </h2>
                            ...
                            <div x-data="{ active: 1 }" class="space-y-0 border-t border-black/10 z-10 relative">
                                ...
                                <div class="border-b border-black/10 py-6">
                                    ...
                                    <div x-show="active === 2" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            We recommend you get your car serviced annually or after every 12,000 miles,
                                ...
                                <div class="border-b border-black/10 py-6">
                                    ...
                                    <div x-show="active === 6" x-collapse>
                                        <p class="mt-4 text-[#0A0A0A] lg:text-lg text-base leading-relaxed max-w-lg">
                                            A voluntary inspection designed to identify faults before the official,
                                            mandatory annual test, helping to avoid failures. It typically includes checking
                                            lights, tires (min 1.6mm tread), wipers, horn, seatbelts, and warning lights.
                                        </p>
                                    </div>
                                </div>
